/*! For license information please see lib-router.f8448fda.js.LICENSE.txt */
'use strict';
(self.webpackChunkresin_hooks = self.webpackChunkresin_hooks || []).push([
  ['118'],
  {
    4969: function (e, t, n) {
        ...
        return (
          ...
          (function (e, t, n, r) {
            ...
            function y() {
              ...
              let e = g(),
                t = null == e ? null : e - m;
              ((m = e), v && v({ action: h, location: R.location, delta: t }));
            }
            function b(e) {
              let t =
            ...
            null == m &&
              ((m = 0), u.replaceState(l({}, u.state, { idx: m }), ''));
            let R = {
              get action() {
                return h;
              },
              ...
              listen(e) {
                ...
                return (
                  i.addEventListener(s, y),
                  (v = e),
                  () => {
                    (i.removeEventListener(s, y), (v = null));
                  }
                );
              },
              createHref: (e) => t(i, e),
              ...
              push: function (e, t) {
                ...
                o && v && v({ action: h, location: R.location, delta: 1 });
              },
              replace: function (e, t) {
                h = a.Replace;
                let r = d(R.location, e, t);
                n && n(r, e);
                let i = p(r, (m = g())),
                  l = R.createHref(r);
                (u.replaceState(i, '', l),
                  o && v && v({ action: h, location: R.location, delta: 0 }));
              },
              go: (e) => u.go(e),
            };
            return R;
            ...
            function (e, t) {
              let { pathname: n, search: a, hash: r } = e.location;
              return d(
                '',
                { pathname: n, search: a, hash: r },
      ...
      function m(e, t, n) {
        return (
          void 0 === n && (n = '/'),
          (function (e, t, n, a) {
            let r = R(('string' == typeof t ? v(t) : t).pathname || '/', n);
            if (null == r) return null;
            let i = (function e(t, n, a, r) {
              (void 0 === n && (n = []),
                void 0 === a && (a = []),
                void 0 === r && (r = ''));
              let i = (t, i, o) => {
              ...
              o = (function (e, t, n) {
                ...
                for (let e = 0; e < a.length; ++e) {
                  ...
                  (Object.assign(r, c.params),
                    o.push({
                      params: r,
                      pathname: E([i, c.pathname]),
                      pathnameBase: _(E([i, c.pathnameBase])),
                      route: h,
                    }),
                    '/' !== c.pathnameBase && (i = E([i, c.pathnameBase])));
                }
                return o;
              })(i[e], t, a);
            }
      ...
      function b(e, t) {
        ...
        return {
          params: s.reduce((e, t, n) => {
            let { paramName: a, isOptional: r } = t;
            if ('*' === a) {
              let e = d[n] || '';
      ...
      function C(e, t, n, a) {
        ...
        (void 0 === a && (a = !1),
          'string' == typeof e
            ? (r = v(e))
            : (c(
                !(r = l({}, e)).pathname || !r.pathname.includes('?'),
                x('?', 'pathname', 'search', r),
              ),
              c(
              ...
              a
                ? w(a)
                  ...
                  : (a.includes('//') &&
                    ...
                    (n = a.startsWith('/') ? P(a.substring(1), '/') : P(a, t)))
                : (n = t),
              { pathname: n, search: k(r), hash: L(i) }
            );
          })(r, i),
          p = s && '/' !== s && s.endsWith('/'),
          d = (o || '.' === s) && n.endsWith('/');
        return (
          !u.pathname.endsWith('/') && (p || d) && (u.pathname += '/'),
          u
        );
      }
      let E = (e) => e.join('/').replace(/\/\/+/g, '/'),
    ...
    2496: function (e, t, n) {
          ...
          new URLSearchParams(
            'string' == typeof e ||
              ...
              : Object.keys(e).reduce((t, n) => {
                  let a = e[n];
                  return t.concat(
                    Array.isArray(a) ? a.map((e) => [n, e]) : [[n, a]],
                  );
                }, []),
          )
        );
      ...
      let f = (i || (i = n.t(u, 2))).startTransition;
      function v(e) {
        let { basename: t, children: n, future: a, window: r } = e,
          i = u.useRef();
        null == i.current &&
          (i.current = (0, p.lX)({ window: r, v5Compat: !0 }));
        let o = i.current,
          [l, s] = u.useState({ action: o.action, location: o.location }),
        ...
        return (
          u.useLayoutEffect(() => o.listen(d), [o, d]),
          u.useEffect(() => (0, h.$A)(a), [a]),
          u.createElement(h.F0, {
            basename: t,
            children: n,
            location: l.location,
      ...
      function m(e) {
        let t = u.useRef(d(e)),
          ...
          r = u.useMemo(() => {
            ...
            return (
              (e = a.search),
              (r = n.current ? null : t.current),
              (i = d(e)),
              r &&
                r.forEach((e, t) => {
                  i.has(t) ||
                    r.getAll(t).forEach((e) => {
                      i.append(t, e);
                    });
                }),
              i
          ...
          o = u.useCallback(
            (e, t) => {
              let a = d('function' == typeof e ? e(r) : e);
              ((n.current = !0), i('?' + a, t));
            },
            [i, r],
          );
      ...
      ((o || (o = n.t(c, 2))).flushSync,
        (i || (i = n.t(u, 2))).useId,
        'undefined' != typeof window &&
          void 0 !== window.document &&
          window.document.createElement,
        ((a = l || (l = {})).UseScrollRestoration = 'useScrollRestoration'),
    ...
    1468: function (e, t, n) {
      ...
      let c = l.createContext(null),
        ...
        d = l.createContext({ outlet: null, matches: [], isDataRoute: !1 });
      function f() {
        return null != l.useContext(p);
      }
      function v() {
        return (f() || (0, s.J0)(!1), l.useContext(p).location);
      }
      function m(e) {
        l.useContext(h).static || l.useLayoutEffect(e);
      }
      function g() {
        let { isDataRoute: e } = l.useContext(d);
        return e
          ? (function () {
              var e, t;
              let n,
                ...
                { router: o } =
                  (y.UseNavigateStable,
                  (n = l.useContext(c)) || (0, s.J0)(!1),
                  n),
                h =
                  (b.UseNavigateStable,
                  (i = ((a = l.useContext(d)) || (0, s.J0)(!1), (r = a))
                  ...
                  function (e, t) {
                    (void 0 === t && (t = {}),
                      p.current &&
                        ('number' == typeof e
                          ? o.navigate(e)
                          : o.navigate(e, u({ fromRouteId: h }, t))));
                  },
                  [o, h],
                )
              );
          ...
          : (function () {
              ...
              let e = l.useContext(c),
                { basename: t, future: n, navigator: a } = l.useContext(h),
                { matches: r } = l.useContext(d),
                { pathname: i } = v(),
                o = JSON.stringify((0, s.cm)(r, n.v7_relativeSplatPath)),
                u = l.useRef(!1);
              return (
                m(() => {
                  u.current = !0;
      ...
      let R = (e, t, n) => {};
      function S(e, t) {
        ((null == e ? void 0 : e.v7_startTransition) === void 0 &&
          R(
            'v7_startTransition',
          ...
          (null == e ? void 0 : e.v7_relativeSplatPath) !== void 0 ||
            (t && void 0 !== t.v7_relativeSplatPath) ||
            R(
      ...
      function w(e) {
        ...
        return null == S
          ...
          : l.createElement(
              h.Provider,
              { value: v },
              l.createElement(p.Provider, { children: n, value: S }),
            );
      }
      (o || (o = n.t(l, 2))).startTransition;
      var P =
        (((i = P || {})[(i.pending = 0)] = 'pending'),
